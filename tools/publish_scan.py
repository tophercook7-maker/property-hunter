...
def once():
    ...
    subprocess.run(["git", "add", "docs/data/scan", "docs/data/scan_index.json", "docs/data/garland.json", "docs/data/status.json", "docs/data/hunt_status.json", "docs/data/changes.json", "docs/data/counties.json", "docs/data/signals.json", "docs/data/radar.json", "docs/data/tax_sources.json", "docs/data/investigations.json", "docs/data/timeline", "docs/garland.html", "hunter/static/share.html"], cwd=ROOT, check=False)
